...
-- Every Disasters Synced

Config = {}

Config.Admin = "admin" -- Admin group

Config.Commandspawn = "spawndisasters" -- Spawn all Disasters

Config.Commanddel = "deldisasters" -- Delete all Disasters

Config.blip = true  -- true/false/"onlyjobs"

Config.blipjobs = { -- Blips show only jobs
	"police",
	"firefighter",
}

Config.axe1 = "WEAPON_BATTLEAXE"  -- for trees

Config.axe2 = "WEAPON_HATCHET" -- for trees
...
Config.reward_tree = {   --Random get loot from these items. (If Config.reward = "item")
			{
				item = "bandage",
				minamount = 1,
				maxamount = 5,
...
Config.reward_rock = {   --Random get loot from these items. (If Config.reward = "item")
			{
				item = "bandage",
				minamount = 1,
				maxamount = 5,
...
Config.reward_car = {   --Random get loot from these items. (If Config.reward = "item")
			{
				item = "bandage",
				minamount = 1,
				maxamount = 5,
...
Config.spawntime_min = 20 -- Random spawn time minimum in minutes (New Disasters spawn time or chopped Tree respawn minimum time in minute)

Config.spawntime_max = 90 -- Random spawn time maximum in minutes (New Disasters spawn time or chopped Tree respawn maximum time in minute)

Config.spawn_min = 10 --Random spawn amount minimum 

Config.spawn_max = 20 --Random spawn amount maximum

Config.Locales = {
	treetext = "Press ~g~E~s~ to start chopping",
	noaxe = "~r~You don't have Axe in your hand!~s~",
	fallentreeblip = "Fallen Tree",
	rocktext = "Press ~g~E~s~ to start mining",
	nopickaxe = "~r~You don't have Pickaxe!~s~",
	fallenrockblip = "Rock Fall",
	carwreckblip = "Car Wreck",
	cartext = "Press ~g~E~s~ to Attach Tow Rope",
}

Config.Car_delivery = vector3(404.0,-1642.32,29.28)

Config.Cars = {  -- Car Wrecks
{coords = vector3(402.52,-1068.4,29.32), heading = 218.76},
{coords = vector3(497.6,-1254.48,29.32), heading = 164.8},
{coords = vector3(168.28,-824.24,31.2), heading = 211.92},
{coords = vector3(219.4,-1037.04,29.36), heading = 211.92},
{coords = vector3(937.16,211.12,77.48), heading = 143.68},
{coords = vector3(913.96,210.2,77.44), heading = 154.0},
{coords = vector3(-631.24,-661.36,31.72), heading = 47.04},


}

Config.Rocks = {  -- Rocks coordinates
{coords = vector3(2105.28,6035.24,50.6), heading = 231.84},
{coords = vector3(2860.2,5015.04,32.04), heading = 309.44},
{coords = vector3(1136.44,6482.0,21.08), heading = 183.28},
{coords = vector3(-995.0,5383.08,41.28), heading = 204.72},
{coords = vector3(-2722.52,2264.68,20.2), heading = 52.16},
{coords = vector3(1904.8,2348.64,54.6), heading = 348.56},
{coords = vector3(1784.96,2204.56,61.64), heading = 93.4},
{coords = vector3(146.64,1538.0,234.16), heading = 183.2},
{coords = vector3(-629.12,996.44,239.96), heading = 261.84},
{coords = vector3(-1904.84,695.68,127.4), heading = 313.32},
{coords = vector3(-2647.2,-77.48,17.72), heading = 127.76},
{coords = vector3(2173.04,-513.32,93.44), heading = 142.28},
{coords = vector3(1714.76,-2057.12,107.76), heading = 347.4},
{coords = vector3(-644.64,3010.88,24.56), heading = 104.2},
{coords = vector3(-1296.28,2485.96,22.4), heading = 130.88},
{coords = vector3(-2387.56,3474.96,24.0), heading = 14.12},
{coords = vector3(-63.2,4377.92,54.56), heading = 347.12},
{coords = vector3(3003.28,3457.56,71.6), heading = 90.88},
{coords = vector3(-738.24,4031.04,143.6), heading = 71.04},
{coords = vector3(-963.44,5002.92,182.6), heading = 85.36},
}
